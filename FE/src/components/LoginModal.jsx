        ...
        try {
            ...
            if (response?.accessToken) {
                ...
                try {
                    ...
                    const userRole = profileResponse?.user?.role;
            ...
            <div className="w-full md:w-3/5 flex flex-col bg-white">
                <div className="px-10 py-12 flex-1 overflow-y-auto">
                    <div className="mb-10">
                        ...
                        <p className="text-gray-500 text-base">Đăng nhập vào tài khoản để tiếp tục</p>
                    </div>
                            ...
                            <button
                                ...
                                onClick={(e) => {
                                    ...
                                    if (onSwitchToForgotPassword) {
                                        onClose();
                                        setTimeout(() => onSwitchToForgotPassword(), 100);
                                    }
                                }}
                                className="text-sm text-blue-600 hover:text-blue-700 font-medium transition-colors cursor-pointer z-10 relative pointer-events-auto"
                        ...
                        <div className="text-center pt-4">
                            <p className="text-sm text-gray-500">
                                ...
                                <button
                                    ...
                                    className="font-semibold text-blue-600 hover:text-blue-700 underline transition-colors cursor-pointer z-10 relative pointer-events-auto"
                                    style={{ pointerEvents: 'auto' }}
                                >
                                    Đăng ký
                                </button>
